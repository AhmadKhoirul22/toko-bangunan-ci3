				...
				<div class="intro-y box overflow-hidden mt-5">
                    ...
                    <div class="px-5 sm:px-16 py-10 sm:py-20">
                        <div class="overflow-x-auto">
                            <table class="table">
                                ...
                                <tbody>
									<?php $no=1; $total_harga = $utang['total_harga']; foreach($detail as $detail){ ?>
                                    <tr>
                    ...
                    <!-- input -->
					 ...
					 <div class="intro-y col-span-12 lg:col-span-4" >
						...
						<div class="intro-y col-span-12 lg:col-span-4 mb-4" >
						<form action="<?= base_url('piutangpenjualan/bayarcicilan') ?>" method="post">
							...
							<div class="intro-y box p-5 mt-5">
								<div>
									...
									<input type="hidden" name="kode_penjualan" value="<?= $utang['kode_penjualan'] ?>" >
								</div>
								<div class="mt-3">
