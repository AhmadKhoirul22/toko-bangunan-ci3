        ...
        <div class="content">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-span-12 mt-8">
						...
						<div class="w-full">
							<a href="javascript:;" data-toggle="modal" data-target="#superlarge-modal-size-preview"
								class="button mr-1 mb-2 inline-block bg-theme-1 text-white">Tambah Pembelian</a>
						</div>
						<div class="text-right w-full">
						<a href="<?= base_url('piutangpembelian') ?>"
						...
						<div class="modal" id="datepicker-modal-preview">
							<div class="modal__content">
								...
								<form action="<?= base_url('pdfpembelian/cetakpembelian') ?>" method="post" target="_blank">
						...
						<table
							...
							<thead>
								<tr>
									...
									<th class="text-center">Telp Supplier</th>
									...
									<td class="table-report__action w-56">
										<div class="flex justify-center items-center">
											<a class="flex items-center mr-3"
												href="<?= base_url('pembelian/transaksi/'.$row['id_supplier']) ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
					...
					<!-- table -->
					<div class="intro-y datatable-wrapper box p-5 mt-5">
					<h2 class="text-center font-medium text-lg" >Pembelian Bulan ini</h2>
						<table
							class="table table-report table-report--bordered display datatable w-full dataTable no-footer dtr-inline collapsed"
							id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
							<thead>
								...
								<tr class="intro-x">
									...
									<td class="table-report__action w-56">
										...
										<a class="flex items-center mr-3" data-toggle="modal" data-target=""
												href="<?= base_url('pembelian/invoice/'.$row['kode_pembelian']) ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
													viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
													stroke-linejoin="round" class="feather feather-check-square w-4 h-4 mr-1">
													<polyline points="9 11 12 14 22 4"></polyline>
													<path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path>
										...
										<?php if($row['status'] == 'SELESAI'){ ?>
										 <form action="<?= base_url('pembelian/update/'.$row['kode_pembelian']) ?>" method="post" >
											<?php foreach($detail as $item){ ?>
												<input type="hidden" name="id_produk" value="<?= $item['id_produk'] ?>" >
												<input type="hidden" name="jumlah" value="<?= $item['jumlah'] ?>" >
											<?php } ?>
												<input type="hidden" name="status" value="DICANCEL" >
												<button class="flex items-center text-theme-6" type="submit" onclick="return confirm('yakin untuk mengcancel pembelian?')" >
