                    ...
                    <div class="border-b border-gray-200 text-center sm:text-left">
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5 lg:ml-10">
                            <div class="intro-y col-span-12 lg:col-span-4">
                                ...
                                <div class="mt-1">Telp : <?= $utang['telp_supplier'] ?>.</div>
                            </div>
                            <div class="intro-y col-span-12 lg:col-span-4">
							...
							<div class="intro-y col-span-12 lg:col-span-4">
                                ...
                                <div class="mt-1">No Nota : <?= $utang['kode_pembelian'] ?></div>
                    ...
                    <div class="px-5 sm:px-16 py-10 sm:py-20">
                        <div class="overflow-x-auto">
                            <table class="table">
                                ...
                                <tbody>
									<?php $no=1; $total_harga = $utang['total_harga']; foreach($pembelian as $detail){ ?>
                                    <tr>
						...
						<div class="intro-y col-span-12 lg:col-span-4" >
							<table class="table" >
								...
								<tr>
									<td></td>
									<td>
									<a target="_blank" href="<?= base_url('pembelian/cetakinvoice/'.$utang['kode_pembelian']) ?>" class="button w-24 inline block mr-1 mb-2 bg-theme-1 text-white" >Print PDF</a>
									</td>
								</tr>
								<tr>
									<td></td>
									<td>
									<a target="_blank" href="<?= base_url('pembelian/cetaknota/'.$utang['kode_pembelian']) ?>" class="button w-24 inline block mr-1 mb-2 bg-theme-1 text-white" >Print Nota</a>
