			...
			<div class="text-right w-full">
				...
				<div class="modal" id="datepicker-modal-preview">
					<div class="modal__content">
						...
						<form action="<?= base_url('pdfpembelian/status') ?>" method="post" target="_blank">
				...
				<div class="modal" id="datepicker-modal-preview_cicilan">
					<div class="modal__content">
						...
						<form action="<?= base_url('pdfpembelian/cetakcicilan') ?>" method="post" target="_blank">
							<div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
								<div class="col-span-12 sm:col-span-6">
									<label>From</label>
									<div class="relative w-56 mx-auto">
				...
				<div class="modal" id="datepicker-modal-preview_pembayaran">
					<div class="modal__content">
						...
						<form action="<?= base_url('pdfpembelian/cetakpembayaran') ?>" method="post" target="_blank">
							<div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
								<div class="col-span-12 sm:col-span-6">
									<label>From</label>
									<div class="relative w-56 mx-auto">
				...
				<div class="intro-y datatable-wrapper box p-5 mt-5">
						<table
							...
							<tbody>
								<?php $no=1; foreach($utang_pembelian as $row){ ?>
								<tr class="intro-x">
									<td class="text-center" > <?= $no++; ?> </td>
									<td class="text-center" > <?= $row['kode_pembelian'] ?> </td>
									...
									<td class="table-report__action w-56">
										<div class="flex justify-center items-center">
											<a class="flex items-center mr-3"
												href="<?= base_url('piutangpembelian/cicilan/'.$row['kode_pembelian']) ?>">
